        ...
        <Stack spacing={3}>
          ...
          {!loading && !error && (
            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2} alignItems={{ xs: 'stretch', sm: 'center' }}>
              <TextField id="search" name="search" placeholder="Search by title" value={q} onChange={e => setQ(e.target.value)} fullWidth />
              <Select id="filter-status" name="status" value={fStatus} onChange={e => setFStatus(e.target.value)} displayEmpty sx={{ minWidth: 180 }}>
                <MenuItem value="All">All Statuses</MenuItem>
                <MenuItem value="Todo">Todo</MenuItem>
                <MenuItem value="In Progress">In Progress</MenuItem>
                <MenuItem value="Done">Done</MenuItem>
              </Select>
              <Select id="filter-priority" name="priority" value={fPriority} onChange={e => setFPriority(e.target.value)} displayEmpty sx={{ minWidth: 180 }}>

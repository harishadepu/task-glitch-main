      ...
      <DialogContent>
        <Stack spacing={2} mt={1}>
          ...
          <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
            <TextField id="details-revenue" name="revenue" label="Revenue" type="number" value={revenue} onChange={e => setRevenue(e.target.value === '' ? '' : Number(e.target.value))} fullWidth />
            <TextField id="details-timeTaken" name="timeTaken" label="Time Taken (h)" type="number" value={timeTaken} onChange={e => setTimeTaken(e.target.value === '' ? '' : Number(e.target.value))} fullWidth />
          </Stack>
          <TextField id="details-notes" name="notes" label="Notes" value={notes} onChange={e => setNotes(e.target.value)} multiline minRows={3} />
